...
--------------------------*/
const meta = {
  title: "Naisargika - Service Design",
  abstract: "A collaborative service design project analyzing and enhancing the local wood-pressed oil ecosystem to improve customer and stakeholder experiences.",
  role: "Primary Researcher & project Lead",
  tags: ["business strategy","research","service design"],
