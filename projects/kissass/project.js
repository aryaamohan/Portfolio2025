...
--------------------------*/
const meta = {
  title: "Kiss Ass - Game Design",
  abstract: "Kiss Ass is a fast-paced, lighthearted card game where office interns compete through strategy and mischief to land the coveted full-time job.",
  role: "Experience & Game Designer",
  tags: ["game design","ux","play-testing"],
